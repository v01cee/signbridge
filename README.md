...
- 🎯 **Тренировка** — интерактивное заучивание жестов: викторина (угадай жест по описанию) и карточки (самопроверка) с сериями ответов, серией дней подряд и прогрессом освоения по каждому жесту
